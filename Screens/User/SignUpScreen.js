 ...
 const SignUpScreen = props => {
    ...
    const authHandler = useCallback(async () => {
        ...
        try{
            ...
            setError(null);
            setIsLoading(true);           
            dispatch(AuthActions.signUp(formState.inputs.email, formState.inputs.password));
    ...
    return (        
        <LinearGradient colors = {['#EC6F66', '#F3A183']} style = {styles.gradient}>
            <View style = {styles.container}>
                ...
                </View> :<Button title = 'Sign-up' color = {Colors.primaryColor} onPress = {authHandler}/>}</View>
            </View>
        </LinearGradient>
    );
 }
